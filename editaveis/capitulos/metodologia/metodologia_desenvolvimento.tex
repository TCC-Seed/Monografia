...
Como resultado da primeira etapa, foi definida a visão geral do produto: um PWA (\textit{Progressive Web App}), gratuito e \textit{open source}, voltado a estudantes que carecem de assistência à saúde no meio universitário e a profissionais das Instituições de Ensino Superior (IES) que precisam monitorar seus alunos. O produto, denominado Seed, tem como diferencial auxiliar os indivíduos em questões de saúde mental por meio da coleta de dados e da oferta de informações condizentes, além de fomentar a prática de hábitos saudáveis e conectar os estudantes aos pontos de apoio disponíveis em suas IES. Esse último aspecto o diferencia de aplicativos como o Daylio, que atuam apenas na adoção de hábitos saudáveis, sem oferecer suporte institucional aos usuários.
